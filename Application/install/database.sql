...
# Type: 管理员后台手动备份
# Description:当前SQL文件包含了表：pa_access、pa_ad、pa_admin、pa_category、pa_images、pa_link、pa_member、pa_message、pa_nav、pa_news、pa_node、pa_page、pa_product、pa_role、pa_role_user、pa_tag的结构信息，表：pa_access、pa_ad、pa_admin、pa_category、pa_images、pa_link、pa_member、pa_message、pa_nav、pa_news、pa_node、pa_page、pa_product、pa_role、pa_role_user、pa_tag的数据
# Time: 2014-03-20 15:27:15
# -----------------------------------------------------------
# 当前SQL卷标：#1
# -----------------------------------------------------------
...
CREATE TABLE `pa_node` (
  ...
  KEY `status` (`status`),
  KEY `name` (`name`)
) ENGINE=MyISAM AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='权限节点表' ;
...
INSERT INTO `pa_news` VALUES ('14','1','如果对符合购房计划将会根据','激光焊接','结核杆菌','1','几个号','1394438751','','几个号','4','1','1','0','zh-cn');
INSERT INTO `pa_news` VALUES ('15','1','价格具有统一规划集合计划将会','','空军航空','1','','1394438760','','','2','1','1','0','zh-cn');
...
INSERT INTO `pa_product` VALUES ('33','52','添加编辑产品','43.00','543','39','','添加编辑产品','1','添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品','1394437252','','<span style=\"\\&quot;\\\\&quot;\\\\\\\\&quot;\\\\\\\\\\\\\\\\&quot;color:#333333;font-family:Verdana,\\\\\\\\&quot;\\\\&quot;\\&quot;\" geneva,=\"\\&quot;\\\\&quot;\\\\\\\\&quot;\\\\\\\\&quot;\\\\&quot;\\&quot;\" sans-serif;line-height:22px;background-color:#f2f2f2;\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\"=\"\\&quot;\\\\&quot;\\\\\\\\&quot;\\\\\\\\&quot;\\\\&quot;\\&quot;\">添加编辑产品</span>','zh-cn','1','31','1','1');
INSERT INTO `pa_product` VALUES ('34','55','添加编辑产品','43.00','543','49,50,51','','添加编辑产品','1','添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品添加编辑产品','1394441422','1395295064','如果豆腐干豆腐干梵蒂冈','zh-cn','1','23','1','1');
...
# 数据库表：pa_tag 数据信息
INSERT INTO `pa_tag` VALUES ('6','关于我们','aboutus','<h3>
	<img src="/newconist/Uploads/image/product/20140303/20140303081406_87297.jpg" width="100" height="100" align="left" alt="" /> 
</h3>
<p>
	在此处输入内容覆盖多个地方官热风斯蒂芬<span>在此处输入内容覆盖多个地方官热风斯蒂芬<span>在此处输入内容覆盖多个地方官热风斯蒂芬<span>在此处输入内容覆盖多个地方官热风斯蒂芬<span>在此处输入内容覆盖多个地方官热风斯蒂芬<span>在此处输入内容覆盖多个地方官热风斯蒂芬<span>在此处输入内容覆盖多个地方官热风斯蒂芬<span>在此处输入内容覆盖多个地方官热风斯蒂芬<span>在此处输入内容覆盖多个地方官热风斯蒂芬<span>在此处输入内容覆盖多<span></span></span></span></span></span></span></span></span></span></span>
</p>','zh-cn');
